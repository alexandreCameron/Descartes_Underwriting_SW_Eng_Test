...
MAGNITUDE_TYPE_COLUMN = 'magType'
NUMBER_SEISMIC_STATIONS_LOCATION_COLUMN = 'nst'
GAP_COLUMN = 'gap'
MIN_DISTANCE_EPICENTER_STATION_COLUMN = 'dmin'
TRAVEL_TIME_RESIDUAL_COLUMN = 'rms'
CONTRIBUTOR_ID_COLUMN = 'net'
EVENT_IDENTIFIER_COLUMN = 'id'
TIME_UPDATED_COLUMN = 'updated'
PLACE_COLUMN = 'place'
EVENT_TYPE_COLUMN = 'type'
HORIZONTAL_ERROR_COLUMN = 'horizontalError'
DEPTH_ERROR_COLUMN = 'depthError'
MAGNITUDE_ERROR_COLUMN = 'magError'
NUMBER_SEISMIC_STATIONS_MAGNITUDE_COLUMN = 'magNst'
STATUS_COLUMN = 'status'
LOCATION_SOURCE_COLUMN = 'locationSource'
MAGNITUDE_SOURCE_COLUMN = 'magSource'
